    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Write a new blog post in English and Japanese</p>
        </div>

        <div className="grid lg:grid-cols-3 gap-8">
          {/* Main Form */}
          <div className="lg:col-span-2">
            <form id="main-form" action={createPost} className="bg-white rounded-lg shadow p-6 space-y-6">
              {/* Basic Info */}
              <div>
